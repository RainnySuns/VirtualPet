...
public class GestureManager : MonoBehaviour
{
    ...
    {
        //For the hand gesture direction front is where the fingers are pointing and up is where the top of the palm is facing
        //For the camera gesture direction front is there the camera is looking nad up is general up

        AddGesture(GestureType.Stop, 0f, 0f, 0f, 0f, 0f, 0f, GestureDirection.Down, GestureDirection.Front, 0.6f);
        AddGesture(GestureType.Pinch, 0.8f, 1f, 0.8f, 1f, 0f, 1f,GestureDirection.Down, GestureDirection.Front , 0.6f);
        AddGesture(GestureType.ThumbsUp, 0f, 0f, 0.3f, 1f, 0.3f, 1f, GestureDirection.Left,GestureDirection.Up, 0.6f);
        AddGesture(GestureType.Fist, 0.9f, 1f, 0.9f, 1f, 0.9f, 1f, GestureDirection.Front,GestureDirection.Front, 0.6f);
    }
